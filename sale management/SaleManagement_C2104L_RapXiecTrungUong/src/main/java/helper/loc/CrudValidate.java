...
//			Another way to code, can replace to the loop above
//			if(ids.stream().anyMatch(idElement -> element.getPropertiesId() == idElement)) {
//				lbl.setText("<html>*The property is being<br/> used elsewhere!</html>");
//				validate = true;
//			}
		}
...
//		Another way to code, can replace to the loop above
//		if(HelperFunction.getOrderDetailDb().stream().anyMatch(element -> element.getProductId() == id)) {
//			validate = true;
//			lbl.setText("<html>*The product is being<br/> used elsewhere</html>");
//		}
...
//			Another way to code, can replace to the loop above
//			if(ids.stream().anyMatch(idElement -> element.getProductId() == idElement)) {
//				lbl.setText("<html>*The product is being<br/> used elsewhere!</html>");
//				validate = true;
//			}
		}
	...
	public static boolean isProductContainPp(int id, JLabel lbl) {
		//This is for when you want to check if a product contain property
		boolean validate = false;
		var dao = new ProductPropertiesDao();
		for(var element : dao.getDb()) {
			if(element.getProductId() == id) {
...
//		Another way to code, can replace to the loop above
//		if(dao.getDb().stream().anyMatch(element -> element.getProductId() == id)) {
//			lbl.setText("<html>*The product is being<br/> used elsewhere!</html>");
//			validate = true;
//		}
...
//		Another way to code, can replace to the loop above
//		if(ppList.stream().anyMatch(element -> element.getPropertiesId() == pro.getId())) {
//			lbl.setText("*Duplicate property");
//			validate = true;
//		}
...
//					Another way to code, can replace to the loop above
//					proList = dao.getDb().stream()
//										.filter(element -> pp.getPropertiesId() == element.getId())
...
//				Another way to code, can replace to the loop above
//				if(proList.stream().anyMatch(element -> element.getParentId() == pro.getParentId())) {
//					lbl.setText("<html>*There can be only one choosen child property<br/> per parent property</html>");
//					validate = false;
//				}else {
//					validate = true;
